...
groups_data = {
    ...
    "第 3 組": {
        "leader": "陳威廷",
        "members": [
            "3-1 陳威廷", "3-2 紀辰諭", "3-3 劉俊麟", "3-4 張又方", "3-5 謝耀德", "3-6 葉迷妮", "3-7 王韶怡", "3-8 郭芳佑", "3-9 王碧宏", "3-10 柯春黛", "3-11 黃玉宙", "3-12 何進德", "3-13 蕭名權", "3-14 戈德", "3-15 蘇献珍", "3-16 張顥嚴", "3-17 陳淑媛", "3-18 林秀婷", "3-19 柯春僖", "3-20 簡麗分", "3-21 賴彩鈴", "3-22 林耘庄", "3-23 黃如榛", "3-24 許媛婷", "3-25 陳薇莉", "3-26 張開明", "3-27 吳翊菱"
        ]
    },
    "第 4 組": {
        "leader": "王國美",
    ...
    "第 10 組": {
        "leader": "黃振育",
        "members": [
            "10-1 黃振育", "10-2 胡詠茹", "10-3 李宜晏", "10-4 鄭宇丞", "10-5 陳世平", "10-6 張金爗", "10-7 陳麗華", "10-8 廖曉萍", "10-9 賴志雄", "10-10 吳東昱", "10-11 趙如薰", "10-12 叢思瑋", "10-13 李學璁", "10-14 黃品齊", "10-15 朱重信", "10-16 林明珠", "10-17 蔡春美", "10-18 楊昌學", "10-19 謝佩穎", "10-20 葉奕新"
        ]
    },
    "第 11 組": {
        "leader": "林美華",
...
if show_admin_login_screen:
    ...
    st.markdown(f'<div class="group-box">ℹ️ 您選取的是 <b>{group_selected}</b>（保溫組長：{leader}） | 系統已鎖定組員編號：<b>{auto_member_id}</b></div>', unsafe_allow_html=True)
    ...
    if st.session_state.get("submitted_successfully", False):
        ...
        cum_sheets = st.number_input("【題目二】您自 2026/3/6 起累計填寫了幾張情緒觀察表（含本週）？ *", min_value=0, max_value=1000, value=0, step=1, key="student_cum_sheets")
        ...
        if submit_btn:
            ...
            female_names = [
                ...
                "叢思瑋", "蔡春美", "曾美芳", "張筱雯", "關婉玲", "曾芳美", "吳美毅",                 "蔡沛妤", "李麗斐", "黃淑清", "梁庭", "嚴惠英", "陳淑芬", "郭瓈灧",                 "黃曉鈺", "陳秀花", "蔡宜均", "林佳慧", "廖袖婷", "葉桂香", "溫婷伊",                 "陳田恬", "張又方", "葉迷妮", "王韶怡", "柯春黛", "陳淑媛", "陳薇莉",                 "吳翊菱", "簡麗分", "蘇獻珍", "林秀婷", "柯春僖", "賴彩鈴", "林耘庄",                 "黃如榛", "許媛婷", "鄭翊汝", "李濱如", "洪筱婷", "劉以婕", "陳芸詞",                 "張麗卿", "潘秋華", "留千惠", "張玉芳", "曾麗珍", "鄭美華", "周秀芬"
            ]
