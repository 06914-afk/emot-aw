...
<style>
    ...
    /* 💡 v35 新增：為表格外層容器設定視窗範圍、滾動條與圓角框，防範極長數據拉伸版面 */
    div[data-testid="stTable"] {
        ...
        background-color: #FFFFFF !important;
        -webkit-overflow-scrolling: touch !important; /* 確保 iOS 手機端滑動極致流暢 */
    }
    /* 保持整個 thead, tr 與 th 固定在頂部，極致防護手機端與電腦端滾動時移位 */
    div[data-testid="stTable"] thead, 
    div[data-testid="stTable"] thead tr, 
    div[data-testid="stTable"] th {
        position: sticky !important;
        top: 0 !important;
        z-index: 99 !important; /* 提高 z-index 層級，確保在滾動時絕對壓在下方資料格之上 */
    }
    div[data-testid="stTable"] th {
        background-color: #EBF3EC !important;
        box-shadow: 0 1px 0 #D5E5DE, 0 2px 4px rgba(0,0,0,0.04) !important; /* 加上微幅陰影，滾動時更顯立體與邊界 */
    }
