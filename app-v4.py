...
if show_admin_login_screen:
    ...
    if st.session_state.get("submitted_successfully", False):
        ...
        weekly_sheets = st.number_input("您本週寫了幾張情緒觀察表？ *", min_value=0, max_value=100, value=0, step=1, key="student_weekly_sheets")
        ...
        st.write("---")
        feedback = st.text_area("5.心得、困難或對法師提問", placeholder="請輸入您當週的觀察心得，或是想對法師提出的疑問...", key="student_feedback")
